    ...
    for folder in folders:
        ...
        for md_file in md_files:
            if md_file.startswith(os.path.join(path, folder)):
                ...
                folder_md_files.append(
                    f"'https://github.com/open-academy/machine-learning/tree/main/{md_file}',\n"
                )
        ...
        if folder_md_files:
            with open(
                r"chatbot\vector-db-persist-directory\resources\{}.txt".format(folder),
                "w",
            ) as f:
