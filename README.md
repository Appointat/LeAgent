...
3. Refine chain type
At the same time, we also consider how to deal with special conversation scenarios, such as inhumane questions or questions completely unrelated to data science.
